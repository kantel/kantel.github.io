...
habe ich da (noch auskommentiert) durchaus vorgesehen, daß mit `enemy.kill()` der Gegener auch aus dem Spiel entfernt wird (dann müßte allerdings `enemy.reset()` auskommentiert werden).
...
und besitzt einen Timer, der sie nach dem Ende der Explosion wieder aus dem Spiel entfernt.
