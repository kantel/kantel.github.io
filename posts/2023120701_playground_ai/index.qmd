...
Zwar scheint Playground AI unter anderem auch mit Stable Diffusion gefüttert zu werden, der Dienst besitzt jedenfalls die Modelle Stable Diffusion 1.5 und Stable Diffusion XL mit jeweils den gleichen Styles, wie sie auch bei [Leonardo AI](http://cognitiones.kantel-chaos-team.de/technikgeschichte/rechnerundnetze/leonardoai.html) als Default mitgeliedert werden, aber interessant ist eigentlich das hauseigene Modell »Playground v2«. Dafür gibt es zwar keine Styles, aber ich habe dem Prompt (siehe unten) Stilwünsche mitgeben können, die dann auch berücksichtigt wurden:
