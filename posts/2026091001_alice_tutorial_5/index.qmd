...
Daneben können auch konkreten Makros Variablen zugeweisen werden, zum Beispiel
...
Das einfachste Beispiel eines Hooks folgt diesem Schema (vergleiche auch das Beispiel oben):
...
Ansonsten ist in der Passage nur noch ein weiteres Beispiel der `if:` und `else:` Konstruktion: Wenn (`if:`) der Schlüssel **unter der** Fußmatte lag, dann wird das auch im Text so angezeigt, andernfalls (`else:`) lag der Schlüssel **im** Blumentopf oder **im** Krug.
