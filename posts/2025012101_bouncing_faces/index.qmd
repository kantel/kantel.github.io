...
Auch wenn ich doch gemerkt hatte, daß ich, weil ich schon ewig nichts mehr mit Pygame angestellt hatte, etliches nachschlagen mußte, war es einfacher, als ich dachte. Und das Ergebnis könnt Ihr hier bewundern (auf »Ready to start!« klicken):
...
Die Bildchen habe ich den [hier schon einmal vorgestellten](https://kantel.github.io/posts/2024042902_openmoji/), freien [OpenMojis](https://kantel.github.io/posts/2024042902_openmoji/) entnommen, mit denen ich schon lange einmal etwas anstellen wollte. Und den [Quellcode mit allen Assets](https://github.com/kantel/pygameprojects/tree/master/bouncingfaces) findet Ihr natürlich auch wieder in meinem GitHub-Repositorium. Habt also Spaß damit!

In meinem Kopf brodeln auch schon wieder etliche Ideen, was ich mit Pygame und Pygbag noch anstellen könnte. Denn Pygame im Browser ist einfach geil. *Still digging!*