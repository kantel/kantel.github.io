...
Der wunderbare Artikel »[Markdown in 2026: Not Just for Writing Anymore](https://kurtis-redux.medium.com/markdown-in-2026-not-just-for-writing-anymore-d4433fa1ec9a)« von *Kurtis Redux* über die Renaissance der Markdown-Editoren im Zeitalter der KI machte mich unter anderem auch auf **[Quarkdown](https://quarkdown.com/)** aufmerksam. Dieses freie (GPL), aus Italien stammende Quarkdown ([GitHub-Repo](https://github.com/iamgio/quarkdown)) will mehr sein, als ein herkömmlicher Markdown-Editor, es versteht sich als ein Markdown-basiertes Satzsystem.
