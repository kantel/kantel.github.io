...
- Das [Interview](https://timrodenbroeker.de/kit-kuksenok-on-p5-js-2-0/) mit *Kit Kuksenok* und *Tim Rodenbröker* anlässlich der Veröffentlichung von P5.js&nbsp;2.0.
- Ein [Video-Tutorial](https://www.youtube.com/watch?v=E2OE-FaMkag), wie man Shader mit `p5.strands` in P5.js&nbsp;2.0 verwendet.
- Ein einstündiger Coding-Train-Livestream mit *Kit Kuksenok* über variable Schriftarten, asynchrones Laden, Text-zu-Konturen-Umwandlung und 3D-Textextrusion in P5.js&nbsp;2.0.
