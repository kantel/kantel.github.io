...
Und was ist nun neu? Nun, einmal besitzt Quarto nun eine bessere Unterstützung für interaktive [Dashboards](https://quarto.org/docs/dashboards/). Diese sind die neueste Sau, die durch das Data Science Dorf getrieben wird und so war es wirklich nur eine Frage der Zeit, bis sich auch Quarte dieser neuen Sau annimmt.
...
Kommen wir zu einem angenhmeren neuen Feature: Quarto besitzt ein neues Publikationsformat für [Manuskripte](https://quarto.org/docs/manuscripts/) und andere (nicht nur wissenschaftliche) Artikel. Das ist eine großartige Ergänzug zum bisherigen Publikationsformat [Books](https://quarto.org/docs/books/) und wird sicher nicht nur meinen Publikationsworkflow bereichern.
...
- Mit der Jupyter-Engine lassen sich aus Quarto heraus Python-, Julia- oder R-Skriptdateien mit Markdown-Kommentaren als eine Art Notebook herausschreiben.
- Und das ist auch für den *Schockwellenreiter* nützlich: Quarto 1.4 unterstützt [Lightbox-Galerien](https://quarto.org/docs/output-formats/html-lightbox-figures.html), mit der Thumbnails mit Beschriftung in einer Art Galerie angzeigt und mit größeren Bildern verlinkt werden köönen. *(Notiz an mich: Unbedingt testen!)*
