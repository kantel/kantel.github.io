...
Meine PVector-Klasse habe ich einfach aus meinem [GitHub-Repositrium](https://github.com/kantel/pvector) kopiert, lediglich den Namen habe ich -- zur Verdeutlichung, das es sich um eine reine 2D-Implementierung handelt -- in `PVector2` geändert:
