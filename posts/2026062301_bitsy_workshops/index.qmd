...
**Bild**: *[Retrogaming mit Bitsy](https://www.flickr.com/photos/schockwellenreiter/55353309575/)*, erstellt mit [Ideogram 4.0](https://ideogram.ai/). Prompt: »*TA friendly, anthropomorphic elephant wearing a green coat, a red-and-white striped T-shirt, and a black beret sits at a massive desk in front of a steampunk-style computer, using an old-fashioned keyboard. Shelves line the wall, crammed with books and steampunk knick-knacks. Through a window, one can see an alternative steampunk Berlin. A big brilliantly colorful poster on one wall, between the shelves, reads "Retrogaming with Bitsy". Colored classic Amiercan comic style. Language: German. No textboxes, no speech bubbles, no headlines.*«