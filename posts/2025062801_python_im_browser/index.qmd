...
categories: [Python, TigerJython, Trinket, Turtle, VPython, PyScript, Proseco, Pygame, Pygbag, Pyxel, microStudio, Brython, Creative Coding]
...
Proseco scheint so etwas zu sein, von dem ich die letzten Monate geträumt habe: **[Py5 im Browser](https://kantel.github.io/posts/2024072701_py5_pyscript/)**. Ich kann es kaum erwarten, erste Tests zu fahren, um festzustellen, ob Proseco dieses Versprechen auch wirklich einlöst. Ich habe also wieder zu tun. *Still digging!*
