...
Die Idee zu dieser Konstruktion habe ich von hier[^1] und der rekursive Quellcode ist meinem [ersten Beispielen mit fraktalen Bäumen](https://kantel.github.io/posts/2025073001_fraktaler_baum/) sehr ähnlich, nur daß der »Baum« nun absolut symmetrisch ist:

[^1]: Daniel Shiffman: *The Nature of Code*, 2024, Seiten 398ff.
...
- Daniel Shiffman: *The Nature of Code. Simulating Natural Systems with JavaScript*, San Francisco CA (no starch press) 2024
...
Den Quellcode für die Trinket-Versionen [Fraktaler Baum](https://trinket.io/python/08915dce7bd0) und [Fraktaler Baum (2)](https://trinket.io/python/f47c933d23ba) könnt ihr in meinen Trinkets finden, die Quellcodes für CPython ([fraktaltree1.py](https://github.com/kantel/turtlepy/blob/master/sources/trees/fraktaltree1.py) und [fraktaltree2.py](https://github.com/kantel/turtlepy/blob/master/sources/trees/fraktaltree2.py)) findet Ihr auch in meinem GitHub-Repositorium.
