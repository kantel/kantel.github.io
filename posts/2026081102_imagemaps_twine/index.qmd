...
Nur hinter diesen Rechtecken verbirgt sich ein Link, die auf entsprechende Seiten verweisen.
...
<iframe width="800" height="480" src="imagemap_harlowe/"></iframe>

Die Twine-Story passt nicht wirklich auf die Seite (ich hätte das Bild kleiner wählen sollen) und responsiv ist es auch nicht, da die Positionen absolute Koordinaten sind, die eine variable Größe nicht zulassen. Aber um in Twine ein *Point and Click*-Abenteuer zu erstellen, ist die `<map>`-Funktion schon recht brauchbar.
