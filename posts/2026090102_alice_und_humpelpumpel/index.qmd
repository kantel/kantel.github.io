...
Der Linktext mitsant der zugehörigen Link-Formatierung verschwindet also und wird durch den Text im Hook ersetzt. Daraus folgt, wenn der Linktext bleiben soll, müsst ihr ihn im Hook noch einmal wiederholen. Ich habe davon reichlich Gebrauch gemacht, zum Beispiel hier:
...
[^3]: Ich habe in dieser und der folgenden Beispielpassage jeweils zwei `link:`-Makros ineinander verschachtelt und ich hatte dabei ganz schon mit etlichen (Flüchtigkeits-) Fehlern zu kämpfen.
...
Sie ist etwas kompakter geraten und daher kann man hier besser erkennen, wie die Makros ineinander verschachtelt sind.
