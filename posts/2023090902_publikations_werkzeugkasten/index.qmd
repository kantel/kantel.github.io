---
title: "Zim und Typest: Material für meinen Publikationswerkzeugkasten?"
author: "Jörg Kantel"
date: "2023-09-09 17:45:00"
categories: [Typest, Markdown, LaTeX, Visual Studio Code]
image: "images/typest.jpg"
---

[![](images/typest-b.jpg)](https://www.flickr.com/photos/schockwellenreiter/53174989636/)

Im Nachtrag zu [meinem Beitrag](https://kantel.github.io/posts/2023083003_myst_jupyterbook/) über [MyST Markdown](https://mystmd.org/) und [Jupyter Book](https://jupyterbook.org/en/stable/intro.html) trudelten zwei weitere Software-Vorschläge per Email bei mir ein. Einmal das [Zim Desktop Wiki](https://zim-wiki.org/) und dann das Projekt [Typest](https://typst.app/). Ohne mir ein qualifiziertes Urteil anzumaßen, habe ich mir beide kurz angeschaut und (vorläufig) bewertet:
...
In einer ganz anderen Kategorie dagegen spielt **[Typest](https://github.com/typst/typst/blob/main/README.md)**. Die sehr junge (noch Beta) und freie (Apache-2.0-Lizenz) Software aus Berlin ist so etwas wie ein Bastard aus Markdown und LaTeX und will das (wissenschaftliche) Publizieren radikal vereinfachen. Sie möchte daher in der Liga mitspielen, in der auch [Quarto](http://cognitiones.kantel-chaos-team.de/webworking/wiki/dokuwiki.html) und Juypter Book spielen. Es gibt sie als [Kommandozeilen-Tool](https://github.com/typst/typst/releases/tag/v0.7.0) wie auch als Online-Prototypen.
...
Auch wenn solche Tools mit ihren (mehr oder weniger fest vorausgewählten Templates) den Nutzer immer auch ein wenig entmündigen, da sie ihn von den Einzelheiten einer LaTeX- und/oder [Pandoc](http://cognitiones.kantel-chaos-team.de/produktivitaet/visualstudiocode.html)-Installation fernhalten, habe ich mir einen Typest-Account gegönnt. Schaun wir mal, ob und wenn ja, was daraus wird. *Still digging!*
