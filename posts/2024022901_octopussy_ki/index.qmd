...
Ich wollte es wissen: Welchen Einfluß haben die unterschiedlichen Modelle und welchen Einfluß haben die diversen »Stile« (LoRAs) auf die mit Hilfe einer gekünstelten Intelligenzia erzeugten Bilder? Dazu habe ich diverse Tests gefahren und mich dabie als bekennender Open-Source-Evangelist auf einige der diversen [Stable Diffusion](http://cognitiones.kantel-chaos-team.de/technikgeschichte/rechnerundnetze/stablediffusion.html)-Ableger beschränkt. Daneben habe ich mich -- da es sonst die Kapazität meines betagten MacBook Pro (von 2012) überfordert -- auf Online-Tools beschränkt, die wenigstens einen eingeschränkten, kostenlosen Zugang ermöglichen.
