...
Die Beschäftigung mit [Monogatari](https://monogatari.io/) in den letzten Tagen hat mich daran erinnert, daß ich doch mal nachschauen sollte, was meine heimliche Liebe unter den *Visual Novel Engines* macht, [Tuesday&nbsp;JS](http://cognitiones.kantel-chaos-team.de/multimedia/spieleprogrammierung/tuesdayjs.html), die freie (Apache-2.0-Lizenz) JavaScript-basierte Engine für interaktive Geschichten, die mir allein schon deswegen so sympathisch ist, weil ihre Oberfläche mich immer ein wenig an [Twine](http://cognitiones.kantel-chaos-team.de/multimedia/spieleprogrammierung/twine2.html) erinnert.
