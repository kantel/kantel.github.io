...
Wer jetzt auf den Geschmack gekommen ist, kann die aktuelle Version [hier herunterladen](https://www.spyder-ide.org/download/). Und eine Liste aller Neuerungen und Bug-Fixes findet Ihr im [Cangelog](https://github.com/spyder-ide/spyder/blob/6.x/changelogs/Spyder-6.md).