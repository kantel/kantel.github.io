...
Zu meinem gestrigen Versuch, ein von der Hühnerhauswand abprallendes Küken mithilfe von [Pygame](http://cognitiones.kantel-chaos-team.de/multimedia/spieleprogrammierung/pygame.html) ([CE](https://pyga.me/)) und [Pygames Vektorklasse](https://pyga.me/docs/ref/math.html) zu programmieren, hatte der *Gravitar* in [meinen Kommentaren](https://github.com/kantel/kantel.github.io/discussions/241#discussioncomment-12235025) noch ein paar äußerst hilfreiche Anmerkungen, die ich *stante pede* in meinem Programm ([bouncingball_vectors.py](https://github.com/kantel/pythoncuriosa/blob/main/noc/bouncingball_vectors.py)) umgesetzt habe:

So sei der separate import von `pygame.math` nicht mehr notwendig, weil Pygame die Bibliothek gleich mitimportiert. Außerdem könne man den Aufruf der Methode noch mehr verkürzen, wenn man zum Beispiel zu Beginn des Programms
