...
[^1]: Ich folge dabei einem Beispielskript, das ich im [November 2019](http://blog.schockwellenreiter.de/2019/11/2019112002.html) schon einmal in [Processing.py](http://cognitiones.kantel-chaos-team.de/programmierung/creativecoding/processing/processingpy.html) wie auch in JavaScript ([P5.js](http://cognitiones.kantel-chaos-team.de/programmierung/creativecoding/processing/p5js.html)) implementiert hatte.
