...
categories: [Python, Dynamisch Systeme, Mathematik, Processing, Creative Coding]
image: "images/rabbit.jpg"
---

[![](images/rabbit-b.jpg)](https://www.flickr.com/photos/schockwellenreiter/54648032963/)

Heute möchte ich mein [vor zwei Tagen gegebenes Versprechen](https://kantel.github.io/posts/2025060201_spass_mit_tigerjython/) einlösen und mal wieder etwas mit [Py5](http://cognitiones.kantel-chaos-team.de/programmierung/creativecoding/processing/py5.html), dem Python&nbsp;3-Port von Processing, anzustellen. Ich habe dafür den [Pythagoras-Baum](https://de.wikipedia.org/wiki/Pythagoras-Baum) wieder [hervorgekramt](https://kantel.github.io/posts/2025060201_spass_mit_tigerjython/) und in einem leicht anderen Algorithmus[^1], aber auch wieder rekursiv, implementiert.
...
[^2]: Nach Dietmar Herrmann, *Algorithmen für Chaos und Fraktale*, Bonn (Addison-Wesley) 1944, Seiten 170f.
...
Lediglich diese Parameter sind zu ändern, übrige Programm bleibt unverändert.
