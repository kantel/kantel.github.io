---
title: "MicroStudio und Python 2: Zombie Apokalypse"
author: "Jörg Kantel"
...
def distance(obj1, obj2):
  ...
  Nun noch die Credits: Die Bilder sind mal wieder von Kenney, dieses Mal aus seinem freien ([CC0](https://creativecommons.org/publicdomain/zero/1.0/)) Pack [Toon Characters 1](https://kenney.nl/assets/toon-characters-1). Damit sie von microStudio geschluckt werden, habe ich sie auch dieses Mal der [Bildverarbeitung meines Vertrauens](http://cognitiones.kantel-chaos-team.de/multimedia/computergraphik/gc.html) zu den [verlangten Streifen](https://kantel.github.io/posts/2024031201_microstudio_tut_01/) zurechtgeschnitten.
